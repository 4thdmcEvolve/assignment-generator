// Assignment Generator auth endpoint — validates individual subscriber code via Upstash Redis
...
//   Key:   subscriber:<code>          (all lowercase, e.g. subscriber:asgbeta001)
...
//   2. Key: subscriber:<theircode>  (e.g. subscriber:asgbeta001)
...
//
// NOTE: If this tool shares the same Upstash database as LPG and AG,
// one subscriber code covers all three tools automatically.
